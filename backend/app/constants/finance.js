...
export const LEDGER_TRANSACTION_TYPE = {
  ...
  DBT_SUBSIDY_CREDITED: "DBT_SUBSIDY_CREDITED",
  DBT_SUBSIDY_LOCKED: "DBT_SUBSIDY_LOCKED",
  DBT_SUBSIDY_RELEASED: "DBT_SUBSIDY_RELEASED",
  DBT_SUBSIDY_CANCELLED: "DBT_SUBSIDY_CANCELLED",
};
...
export const REFUND_PAYOUT_STATUS = {
  PENDING: "PENDING",
  APPROVED: "APPROVED",
  PROCESSING: "PROCESSING",
  COMPLETED: "COMPLETED",
...
export const REFUND_PAYOUT_METHOD = {
  UPI: "UPI",
  BANK_ACCOUNT: "BANK_ACCOUNT",
};

export const REFUND_AUDIT_ACTION = {
  REFUND_PAYOUT_CREATED: "REFUND_PAYOUT_CREATED",
  REFUND_PAYOUT_VIEWED_DECRYPTED: "REFUND_PAYOUT_VIEWED_DECRYPTED",
  REFUND_PAYOUT_STATUS_UPDATED: "REFUND_PAYOUT_STATUS_UPDATED",
  REFUND_PAYOUT_DETAILS_UPDATED: "REFUND_PAYOUT_DETAILS_UPDATED",
};

export const ALL_REFUND_PAYOUT_STATUSES = Object.values(REFUND_PAYOUT_STATUS);
export const ALL_REFUND_PAYOUT_METHODS = Object.values(REFUND_PAYOUT_METHOD);
export const ALL_REFUND_AUDIT_ACTIONS = Object.values(REFUND_AUDIT_ACTION);
...
export const ALL_FINANCE_AUDIT_ACTIONS = [
  ...Object.values(FINANCE_AUDIT_ACTION),
  ...Object.values(REFUND_AUDIT_ACTION),
];
