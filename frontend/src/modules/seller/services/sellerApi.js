...
export const sellerApi = {
    ...
    submitProfileUpdateRequest: (data) => axiosInstance.post('/seller/profile-request', data),
    getPendingProfileUpdateRequest: () => axiosInstance.get('/seller/profile-request/pending'),
